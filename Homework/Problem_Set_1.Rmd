...
9. In this exercise, we will consider a quadratic equations of the form $(y = \beta_0 + \beta_1 x + \beta_2 x^2)$. Create a vector of coefficients for a quadratci equations.
...
(b) Create 200 values of x from a regulary space vector between -3 and 3
...
$$ x[1]/x[2]^3-1+2*x[3]-x[2-1] = 1/2^3-1*3-1 = 4.125 $$
